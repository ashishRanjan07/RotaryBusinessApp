...
const ClubLowerView = ({memberData}) => {
  // console.log(memberData,"Line 10")
    ...
    const viewProfile = item => {
      ...
      const id = item?.member_business_details?.id;
      if (id) {
        navigation.navigate('Bussiness Details', {id,uuid:memberData?.uuid});
      } else {
        Alert.alert(
          'No Business Found',
          'This member does not have a business profile available.',
          [{text: 'OK'}],
        );
      }
    };
  return (
    <View style={styles.main}>
      ...
      <View style={styles.buttonHolder}>
        ...
        <TouchableOpacity style={[styles.button,{backgroundColor:Colors.blue,gap:5}]}   onPress={() => viewProfile(memberData)}>
